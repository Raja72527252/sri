...
const translations = {
  en: {
    ...
    // About Section
    'about.title': 'About SHRI Homes',
    'about.subtitle': 'Building Dreams',
    'about.description': 'With over two decades of excellence in home building, SHRI has established itself as Melbourne\'s premier luxury home builder, creating extraordinary homes that exceed expectations.',
    ...
    'about.detailedDescription': 'At SHRI Home Builders, we believe that every home should be a reflection of its owner\'s personality and lifestyle. Our team of expert architects, designers, and craftsmen work together to bring your vision to life with unparalleled attention to detail.',
    'about.achievements.title': 'Our Achievements',
    'about.visionTitle': 'Your Vision, Our Expertise',
    'about.whyChooseTitle': 'Why Choose SHRI?',
    ...
    'footer.copyright': '© 2024 SHRI Home Builders. All rights reserved.',

    // Testimonials
    'testimonials.title': 'What Our Clients Say About Us',
    'testimonials.subtitle': 'Don\'t just take our word for it. Here\'s what our satisfied clients have to say about their experience building with SHRI.',
    'testimonials.getInTouch': 'Get In Touch',

    // Why Choose Us
    'whyChoose.title': 'Why Build With SHRI Homes?',
    ...
    'customBuild.description2': 'With SHRI, you\'re not just getting a house – you\'re getting a home designed specifically for you, built with the highest quality materials and craftsmanship in Melbourne.',
    ...
    'faq.subtitle': 'Got questions about building with SHRI? Here are answers to some of the most common questions we receive from our clients.',
    ...
    'faq.difference.question': 'What sets SHRI apart from other builders?',
    ...
    'builderInfo.companyDescription': 'For over 15 years, SHRI has been at the forefront of Melbourne\'s construction industry, delivering exceptional homes that stand the test of time.',
